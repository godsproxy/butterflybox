    ...
    return Title(
        ...
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () async {
              logFirebaseEvent('HOME_FloatingActionButton_5f9epi1d_ON_TA');
                                    ...
                                    child: StreamBuilder<UsersRecord>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return InkWell(
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'HOME_PAGE_PAGE_Column_jzcpmmay_ON_TAP');
                                            logFirebaseEvent(
                                                'Column_navigate_to');
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Container(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOME_PAGE_PAGE_Column_da753bdz_ON_TAP');
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              InkWell(
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'HOME_PAGE_PAGE_Row_g42d902w_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_navigate_to');
                                                                ...
                                                                Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'HOME_PAGE_PAGE_Icon_6rnfjkjj_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Icon_backend_call');
                                                                ...
                                                                Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'HOME_PAGE_PAGE_Icon_lmaoaovh_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Icon_backend_call');
